...
require_once($CFG->dirroot . '/local/equipment/classes/form/newfamilysignup_form.php');
require_once($CFG->dirroot . '/lib/accesslib.php');

// TODO
// This form is no longer in use. We may end up using it for self-enrollment in the future, which is why I'm keeping it. For now it'll just redirect to the new
// VCC form.
if (true) {
    redirect(new moodle_url('/local/equipment/virtualcourseconsent/'), get_string('theformyouattemptedtoaccessisnotcurrentlyavailable', 'local_equipment'), null, \core\output\notification::NOTIFY_WARNING);
}
