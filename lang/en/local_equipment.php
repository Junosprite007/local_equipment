...
$string['mustlogintoyourownaccount'] = 'You cannot fill out the {$a} form unless you are logged into your own, personal {$b} account.';
$string['optin'] = 'Opt in!';
...
$string['phoneverificationcodefor'] = '{$a} is your phone verification code for ${b}.';
