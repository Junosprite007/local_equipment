...
$string['parent_email'] = 'Parent email';
$string['parent_firstname'] = 'Parent first name';
$string['parent_name'] = 'Parent name';
$string['parent_notes'] = 'Parent notes';
$string['parent_lastname'] = 'Parent last name';
$string['parent_phone'] = 'Parent phone';
$string['parent_phone2'] = 'Parent mobile phone';
