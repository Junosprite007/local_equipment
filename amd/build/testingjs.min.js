...
/**
   ...
   */Object.defineProperty(_exports,"__esModule",{value:!0}),_exports.init=void 0,_jquery=_interopRequireDefault(_jquery),_log=_interopRequireDefault(_log),Str=function(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule)return obj;if(null===obj||"object"!=typeof obj&&"function"!=typeof obj)return{default:obj};var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj))return cache.get(obj);var newObj={},hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj)if("default"!==key&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;desc&&(desc.get||desc.set)?Object.defineProperty(newObj,key,desc):newObj[key]=obj[key]}newObj.default=obj,cache&&cache.set(obj,newObj);return newObj}(Str);_exports.init=()=>{(0,_jquery.default)(document).ready((function(){_log.default.debug("Add Partnership Form JS initialized");const updatePartnershipNumbers=()=>{(0,_jquery.default)(".local-equipment-partnership-header").each(((index,element)=>{Str.get_string("partnership","local_equipment",index+1).then((string=>{(0,_jquery.default)(element).text(string)})).catch((error=>{_log.default.error("Error updating partnership header:",error)}))}))},updateHiddenFields=()=>{_log.default.debug("updateHiddenFields");const partnershipsCount=(0,_jquery.default)("fieldset").length;_log.default.debug("Number of fieldsets: ".concat(partnershipsCount)),(0,_jquery.default)('input[name="partnerships"]').val(partnershipsCount);const url=new URL(window.location.href);url.searchParams.set("repeatno",partnershipsCount),window.history.replaceState({},"",url)},updateTrashIcons=()=>{_log.default.debug("updateTrashIcons");(0,_jquery.default)("fieldset").length>1?(0,_jquery.default)(".local-equipment-remove-partnership").show():(0,_jquery.default)(".local-equipment-remove-partnership").hide()};updatePartnershipNumbers(),updateHiddenFields(),updateTrashIcons(),(0,_jquery.default)(document).on("click",".local-equipment-remove-partnership",(function(){_log.default.debug("Event triggered");const $fieldset=(0,_jquery.default)(this).closest("fieldset");_log.default.debug($fieldset);const removedfieldset=$fieldset.remove();_log.default.debug("Fieldset removed"),_log.default.debug("Here's what returned from the '$fieldset.remove()' command:",removedfieldset),updatePartnershipNumbers(),updateHiddenFields(),_log.default.debug("renumberFormElements"),(0,_jquery.default)("fieldset").each(((index,fieldset)=>{_log.default.debug("Renumbering fieldset ".concat(index)),(0,_jquery.default)(fieldset).find("input, select, textarea").each(((_,element)=>{const name=(0,_jquery.default)(element).attr("name");if(name){const newName=name.replace(/\[\d+\]/,"[".concat(index,"]"));(0,_jquery.default)(element).attr("name",newName)}const id=(0,_jquery.default)(element).attr("id");if(id){const newId=id.replace(/_\d+_/,"_".concat(index,"_"));(0,_jquery.default)(element).attr("id",newId)}}))})),updateTrashIcons()}))}))}}));
